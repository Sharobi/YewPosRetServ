...
public class StoredProcedures {
	...
	public static final String PROC_SEARCH_ITEMBY_CODE = "{call get_allItem_SearchByCode(?,?,?,?,?)}";
	public static final String PROC_SEARCH_ITEM_LITE_BYCODE = "{call get_allItem_SearchLite_ByCode(?,?,?,?,?,?)}";
	...
	public static final String PROC_GET_PENDING_SALE_ORDER_DETAILS_BY_INV_NO = "{call get_Pending_SaleOrder_Details_byInvNo(?,?,?,?,?)}";
	...
	public static final String PROC_CREATE_SALE_ORDER = "{call insert_sale_order(?,?,?,?)}";
	...
	public static final String PROC_CREATE_STOCK_TRANSFER = "{call insert_stock_transfer_out(?,?,?,?)}";
	public static final String PROC_GET_STOCK_TRANSFER_DETAILS_ALL = "{call get_allStockTransfer_Details(?,?,?,?,?,?)}";
	public static final String PROC_GET_STOCK_TRANSFER_HEADER_BY_ID = "{call get_StockTransfer_Header_byID(?)}";
	public static final String PROC_GET_STOCK_TRANSFER_DETAILS_BY_ID = "{call get_StockTransfer_Details_byID(?)}";
	public static final String PROC_DISPATCH_STOCK_TRANSFER = "{call update_stock_transfer_dispatch(?,?)}";
	public static final String PROC_DELETE_STOCK_TRANSFER = "{call delete_stock_transfer_out(?,?)}";
	public static final String PROC_CREATE_STOCK_TRANSFER_RECEIVE = "{call update_stock_transfer_in(?,?,?,?)}";
	public static final String PROC_GET_STOCK_TRANSFER_RECEIVE_DETAILS_ALL = "{call get_allStockTransfer_In_Details(?,?,?,?,?,?)}";
	public static final String PROC_RESTOCK_TRANSIT_QTY = "{call restock_transit_qty(?,?,?,?)}";
	public static final String PROC_CLOSE_STOCK_TRANSFER_SEND = "{call update_stock_transfer_send_closure(?,?)}";
	public static final String PROC_CLOSE_STOCK_TRANSFER_RECEIVE = "{call update_stock_transfer_receive_closure(?,?)}";
	...
	public static final String PROC_GET_ALL_MANUAL_EXPIRY_LIST_BY_ITEMID = "{call get_allManualExpiryList_byItemID(?,?,?,?,?,?)}";
	public static final String PROC_GET_ALL_MANUAL_EXPIRY_LIST_BY_ITEMSKU = "{call get_allManualExpiryList_byItemSKU(?,?,?,?,?,?)}";
	...
	public static final String PROC_INSERT_CARD_PAYMENT = "{call insert_card_payment(?,?,?,?,?,?,?,?)}";
	
	public static final String PROC_UPDATE_CARD_PAYMENT = "{call update_card_payment(?,?,?)}";
	public static final String PROC_GET_ALL_CARD_PAYMENT_STATUS = "{call get_all_card_payment_status(?,?)}";
	public static final String PROC_DELETE_CARD_PAYMENT_ID = "{call delete_card_PaytmentID(?,?,?,?,?)}";
	public static final String PROC_GET_ALL_SALE_TRANSACTION = "{call get_all_sale_transaction(?,?)}";
    public static final String PROC_GET_ALLITEM_STOCK_SEARCH = "{call get_allItem_Stock_Search(?,?,?,?,?,?)}";
	public static final String PROC_GET_PURCHASE_HISTORY_ID_BATCH = "{call get_latestPurchase_byItemID_Batch(?,?,?,?,?)}";
	
	public static final String PROC_GET_ALL_SALE_ORDER_DETAILS = "{call get_allSaleOrder_Details(?,?,?,?,?,?,?,?)}";
	public static final String PROC_GET_SALE_ORDER_HEADER_BY_ID = "{call get_SaleOrder_Header_byID(?)}";
	public static final String PROC_GET_SALE_ORDER_DETAILS_BY_ID = "{call get_SaleOrder_Details_byID(?)}";
	public static final String PROC_GET_SALE_ORDER_DETAILS_BY_INV_NO = "{call get_Sale_Order_Details_byInvNo(?,?,?,?)}";
	public static final String PROC_CLOSE_SALE_ORDER = "{call closed_sale_order(?,?,?,?,?)}";
	public static final String PROC_DELETE_SALE_ORDER = "{call delete_sale_order(?,?,?,?,?)}";
	public static final String PROC_POST_SALE_ORDER = "{call posted_sale_order(?,?,?,?)}";
	public static final String PROC_GET_SALES_ORDER_DETAILS_By_Id_FOR_BILL = "{call get_Sale_Order_Details_byID_forBill(?,?,?)}";
	public static final String PROC_GET_SALE_ORDER_HEADER_BY_ID_FOR_BILL = "{call get_Sale_Order_Header_byID_forBill(?,?,?)}";
	public static final String PROC_GET_SALE_ORDER_TAX_DETAILS_BY_ID_FOR_BILL = "{call get_Sale_Order_TaxDetails_byID_forBill(?,?,?)}";
	
	public static final String PROC_CREATE_SALE_TOUR_PLAN = "{call insert_sale_tour_plan(?,?,?,?)}";
	public static final String PROC_GET_ALL_SALE_TOUR_PLAN_DETAILS = "{call get_allSaleTourPlan_Details(?,?,?,?,?,?)}";
	public static final String PROC_GET_SALE_TOUR_PLAN_HEADER_BY_ID = "{call get_SaleTourPlan_Header_byID(?)}";
	public static final String PROC_GET_SALE_TOUR_PLAN_DETAILS_BY_ID = "{call get_SaleTourPlan_Details_byID(?)}";
	public static final String PROC_CANCEL_SALE_TOUR_PLAN = "{call cancel_sale_tour_plan(?,?,?,?,?,?)}";
	public static final String PROC_DELETE_SALE_TOUR_PLAN = "{call delete_sale_tour_plan(?,?,?,?,?)}";
	public static final String PROC_POST_SALE_TOUR_PLAN = "{call posted_sale_tour_plan(?,?,?,?)}";
	public static final String PROC_CREATE_SALE_MAN_TOUR = "{call insert_salesman_tour_details(?,?,?)}";
	public static final String PROC_GET_SALE_MAN_TOUR_DETAILS = "{call get_Salesman_Tour_Details(?,?,?,?,?)}";
	public static final String PROC_GET_SALE_MAN_CHECKIN_STATUS = "{call get_salesman_checkin_status(?,?,?,?,?,?)}";
	public static final String PROC_GET_SALE_MAN_CHECKOUT_STATUS = "{call get_salesman_checkout_status(?,?,?,?,?,?)}";
	public static final String PROC_CREATE_SALE_MAN_TOUR_OFFLINE = "{call insert_salesman_tour_details_offline(?,?,?,?)}";
	...
	public static final String PROC_GET_BILL_PRINT = "{call get_allPrintBill(?,?)}";
	public static final String PROC_GET_BILL_PRINT_DETAILS = "{call get_allPrintBill_Details(?,?)}";
	//hr module
