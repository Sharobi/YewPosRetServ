...
@XmlRootElement
@Entity
@Table(name = "pur_t_purchase_details_serial_mapping")
public class SaleDetailsSerialMapper implements Serializable {
	...
	public SaleDetailsSerialMapper() { }
	...
	public String toString() {
		return "PurchaseDetailsSerialMapper [id=" + id + ", purchaseId=" + purchaseId + ", purchaseDetailsId="
				...
				+ ", tmpMappingId=" + tmpMappingId + ", purchaseInvId=" + purchaseInvId + "]";
	}
