...
public class EmpShiftSchedule implements Serializable{
	...
	public String toString() {
		return "EmpShiftSchedule [id=" + id + ", companyId=" + companyId + ", storeId=" + storeId + ", employee="
				+ employee + ", dutyShiftId=" + dutyShiftId + ", fromDate=" + fromDate + ", fromTime=" + fromTime
				+ ", toDate=" + toDate + ", toTime=" + toTime + ", workingHour=" + workingHour + ", shiftingNo="
				+ shiftingNo + ", isCanceled=" + isCanceled + ", isAmmend=" + isAmmend + ", refShiftId=" + refShiftId
