...
public class EmpAttendance implements Serializable{
	...
	public String toString() {
		return "EmpAttendance [id=" + id + ", companyId=" + companyId + ", storeId=" + storeId + ", employee="
				+ employee + ", dateIn=" + dateIn + ", timeIn=" + timeIn + ", dateOut=" + dateOut + ", timeOut="
				+ timeOut + ", workedHour=" + workedHour + ", inOffice=" + inOffice + ", leaveId=" + leaveId
				+ ", isOffDay=" + isOffDay + ", remarks=" + remarks + ", shiftScheduleId=" + shiftScheduleId
				+ ", overTime=" + overTime + ", grantOverTime=" + grantOverTime + ", createdBy=" + createdBy
