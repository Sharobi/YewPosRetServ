package com.sharobi.pharmacy.hr.service;
...
import com.sharobi.pharmacy.hr.dao.HumanResourceDAO;
import com.sharobi.pharmacy.hr.dao.impl.HumanResourceDAOImpl;
...
public class HumanResourceService {
	...
	private HumanResourceDAO humanResourceDAO =new HumanResourceDAOImpl();
	...
	public String uploadEmpImage(String empId, String fileName,InputStream inputStream) throws Exception {
		...
		try {
			...
			throw new ServiceException(
					"problem occurred while trying to upload emp images", e);
	...
	public String uploadEmpDocImage(String empId,String docName, String fileName,InputStream inputStream) throws Exception {
		...
		try {
			...
			throw new ServiceException(
					"problem occurred while trying to upload emp doc images", e);
